...
from app.services.settings_payload_service import MASKED_VALUE, restore_masked_provider_api_keys
...
def test_restore_masked_provider_api_keys_reuses_stored_keys() -> None:
    ...
    restored = restore_masked_provider_api_keys(providers, existing)

# 中文注释：说明 backend/app/tests/test_windows_notifier.py 的模块职责，便于后续维护定位。
...
def test_windows_notification_prefers_sta_tray_balloon(monkeypatch):
    ...
    def fake_run(args, capture_output, text, timeout, env, **kwargs):  # noqa: ARG001
        calls.append({"args": args, "timeout": timeout, "env": env, **kwargs})
